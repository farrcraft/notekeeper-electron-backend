...
// Arrange is the arrangement direction for a list
type Arrange int

const (
	// ArrangeUp indicates that checked list entries are arranged to the top
	ArrangeUp Arrange = iota
	// ArrangeDown indicates that checked list entries are arranged to the  bottom
	ArrangeDown
)
...
type List struct {
	...
	Direction  Arrange   `json:"direction"`    // Direction indicates when auto arranging wether checked entries are moved to the top or the bottom
